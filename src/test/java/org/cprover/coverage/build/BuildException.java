...
/**
 * Indicates a failure during building of regression test projects.
 */
public class BuildException extends Exception {

  private static final long serialVersionUID = -2784780931654653545L;

  /**
   * Provides a new build failure.
   *
